...
Se suma la assembly `World` con estructuras de terreno simplificadas para iniciar el port del crate `world`. Se añadió además un generador `Noise` básico que se instancia dentro de `WorldIndex` para permitir pruebas deterministas de generación.
